export class ObjectUtils {
  public static isArray(value: any, empty = true) {
    return Array.isArray(value) && (empty || value.length !== 0);
  }

  public static isObject(value: any, empty = true) {
    return (
      typeof value === 'object' &&
      !Array.isArray(value) &&
      value != null &&
  ...
  public static equals(obj1: any, obj2: any, field?: string | null): boolean {
    if (field)
      return (
  ...
  public static deepEquals(a: any, b: any) {
    if (a === b) return true;
