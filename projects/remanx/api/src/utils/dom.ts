/**
 * @dynamic is for runtime initializing Dom.browser
 *
...
export class Dom {
  ...
  public static alignOverlay(
    ...
    if (overlay && target) {
      if (calculateMinWidth) {
        overlay.style.minWidth = `${Dom.getOuterWidth(target)}px`;
      }
  ...
  public static relativePosition(
    ...
    const getClosestRelativeElement: any = (el: any) => {
      if (!el) return;
  ...
  public static fadeIn(element: any, duration: number): void {
    ...
    let tick = function () {
      ...
      if (+opacity < 1) {
        (window.requestAnimationFrame(tick) && requestAnimationFrame(tick)) ||
          setTimeout(tick, 16);
      }
    };
  ...
  public static matches(element: any, selector: string): boolean {
    if (typeof element.matches === 'function') {
      ...
      const matchesFunction = function (this: Element, s: string): boolean {
        return (
          Array.prototype.indexOf.call(document.querySelectorAll(s), this) !==
          -1
        );
      };
  ...
  public static clearSelection(): void {
    ...
    if (selection) {
      ...
      if (documentSelection && typeof documentSelection.empty === 'function') {
        try {
  ...
  public static getFocusableElements(element: any, selector = ''): any[] {
  ...
  public static getFocusableElement(element: any, selector = ''): any | null {
  ...
  public static getFirstFocusableElement(element: any, selector = '') {
    const focusableElements = this.getFocusableElements(element, selector);

    return focusableElements.length > 0 ? focusableElements[0] : null;
  }

  public static getLastFocusableElement(element: any, selector: any) {
    const focusableElements = this.getFocusableElements(element, selector);
  ...
  public static getAttribute(element: any, name: any) {
    if (element) {
  ...
  public static createElement(type: any, attributes = {}, ...children: any[]) {
    if (type) {
  ...
  public static setAttribute(element: any, attribute = '', value: any) {
    if (this.isElement(element) && value !== null && value !== undefined) {
      element.setAttribute(attribute, value);
    }
  }

  public static setAttributes(element: any, attributes = {}) {
    if (this.isElement(element)) {
      const computedStyles = (rule: any, value: any) => {
  ...
  public static isFocusableElement(element: any, selector = '') {
